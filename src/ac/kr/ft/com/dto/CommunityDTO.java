...
public class CommunityDTO {
	...
	private List<CommunityComDTO> rList; // 조회 결과 가져오기
	
	private List<CommunityDTO> eList; // 조회 결과 가져오기
	...
	public List<CommunityDTO> geteList() {
		return eList;
	}



	public void seteList(List<CommunityDTO> eList) {
		this.eList = eList;
	}
