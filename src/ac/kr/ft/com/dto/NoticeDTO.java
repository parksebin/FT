...
public class NoticeDTO {
	...
	private List<NoticeComDTO> rList; // 조회 결과 가져오기
    private List<NoticeDTO> eList; // 조회 결과 가져오기
	...
	public List<NoticeDTO> geteList() {
		return eList;
	}
	...
	public void seteList(List<NoticeDTO> eList) {
		this.eList = eList;
	}
