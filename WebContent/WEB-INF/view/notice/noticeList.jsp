            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">공지사항목록
                        </div>
                        <!-- /.panel-heading -->
               ...
               <th width="90"><input type="checkbox" name="all" onclick="checkboxChange(this.form, this)"/> 전체 </th>
                                    ...
                                    <tbody>
										...
										while(it.hasNext()){
											NoticeDTO noticeDTO = (NoticeDTO)it.next();
                                 ...
                                 <td><input type="checkbox" name="del_chk" value="<%=CmmUtil.nvl(noticeDTO.getNotice_seq())%>"/></td>       
                                 
                                            <td><%=CmmUtil.nvl(noticeDTO.getNotice_seq())%></td>
                                            <td><a href="noticeDetail.do?notice_seq=<%=CmmUtil.nvl(noticeDTO.getNotice_seq())%>"><%=CmmUtil.nvl(noticeDTO.getTitle())%></a></td>
                                            <td><%=CmmUtil.nvl(noticeDTO.getUser_name())%></td>
                                           
                                            <td class="center"><%=CmmUtil.nvl(noticeDTO.getReg_dt())%></td>                                      
                                            <td class="center"><%=CmmUtil.nvl(noticeDTO.getRead_cnt())%></td>
	                            ...
	                            <p align="right">
	                           	    <a href="noticeInsert.do"><button type="button" class="btn btn-outline btn-success" >글쓰기</button></a>
