									...
									<table width="100%"
										...
										<tbody>
											<tr>
												...
												<td>
												<input type="text" name="title" size="50" maxlength="200" class="form-control"
											 onkeyup="fc_chk_byte(this,100);" value="<%=CmmUtil.nvl(noticeDto.getTitle())%>"/>
												</td>
												<td width="60px"><b>등록일</b></td>
												
											
												<td width="200px"><%=CmmUtil.nvl(noticeDto.getReg_dt())%></td>					
											
												
												<td width="100px"><b>조회수</b></td>
												<td width="100px"><%=CmmUtil.nvl(noticeDto.getRead_cnt())%></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td colspan="5"><textarea name="contents" style="width: 600px; height:300px;" class="form-control"
										 onkeyup="fc_chk_byte(this,4000);"><%=CmmUtil.nvl(noticeDto.getContents())%></textarea>
												</td>
											</tr>
										</tbody>
									</table>
