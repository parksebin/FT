				...
				<div class="col-md-4 col-md-offset-4">
					<div class=" panel panel-default">
						...
						<div class="panel-body">
							<form name="f" id="f" method="post" action="pwfindproc.do"
								onsubmit="return doAction(this)">
								<div class="form-group">
									이름<br/><input class="form-control" placeholder="이름" name="user_name"
										type="text" value="" onkeydown="namecheck(this,20)" maxlength="20"/>
								</div>
								<div class="form-group">
									ID<br/><input class="form-control" placeholder="ID" name="user_id"
										type="text" value="" onkeydown="check(this,20)" maxlength="20" />
								</div>

								<div class="form-group" width="30px">
									이메일<br/>
									<input class="form-control" placeholder="이메일" name="email1"
										type="text" value="" onkeydown="emailcheck(this,20)"  maxlength="20"/> 
										@ 
										<input class="form-control" name="email2" type="text" value="" onkeydown="email2check(this,20)" maxlength="20"
										/> 
