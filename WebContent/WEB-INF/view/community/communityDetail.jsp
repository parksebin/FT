...
<script type="text/javascript">
	...
	*/
	...
	function doAction(gubun) {
		...
		if (gubun == "U") {
			f.action = "communityupdateForm.do";
			f.submit();
		} else if (gubun == "D") {
			if (confirm("삭제하시겠습니까?")) {
				f.action = "delete.do";
	...
	//댓글 리스트 조회하기
	function doCommList(){
		xmlHttpPost("/community/CommentList.do", "cmt_seq=<%=CmmUtil.nvl(communityDto.getCmt_seq())%>" , "viewResult");
	...
	function saveComment() {
		...
		if (commentSaveType=="A"){
			var actionUrl = "/community/insertComment.do"; //호출 url 
		...
		//댓글 수정			
			...
			var actionUrl = "/community/updateComment.do"; //호출 url 
	...
	function doCommentDelete(com_seq){
		...
		if(confirm("삭제하시겠습니까?")){
			var actionUrl = "/community/deleteComment.do"; //호출 url 
...
<body onload="doOnload()">
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="panel-heading">고객 커뮤니티 상세</div>
						<!-- /.panel-heading -->
									...
									<table width="60%"
										...
										id="dataTables-example">
											<tr>
												...
												<td style="width: 450px"><%=CmmUtil.nvl(communityDto.getTitle())%></td>
												<td style="width: 70px" ><b>등록일</b></td>											
												<td style="width: 200px"><%=CmmUtil.nvl(communityDto.getReg_dt())%></td>											
												<td  style="width: 70px"><b>조회수</b></td>
												<td style="width: 150px"><%=CmmUtil.nvl(communityDto.getRead_cnt())%></td>
											</tr>

											<tr>
												<td align="center" style="width: 100px"><b>사진</b></td>
												<td colspan="5"><img
													src="<%=CmmUtil.nvl(communityDto.getFile_name())%>" /></td>
											</tr>
											<tr>
												<td align="center"><b>내용</b></td>
												<td colspan="6"><%=CmmUtil.nvl(communityDto.getContents())%></td>
											</tr>
									</table>
	...
	<%-- 	onclick="location.href='deleteComment.do?cmt_seq=<%=communitycomDTO.getCmt_seq()%>&com_seq=<%=communitycomDTO.getCom_seq()%> --%>
							</div>
