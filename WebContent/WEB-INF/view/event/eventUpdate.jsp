									...
									<table width="100%"
										...
										<tbody>
											<tr>
												...
												<td><input type="text" name="title" size="40" 	 onkeyup="fc_chk_byte(this,100);"
													value="<%=CmmUtil.nvl(eventDto.getTitle())%>"  /></td>
												<td><b>등록일</b></td>
												
											
												<td><%=CmmUtil.nvl(eventDto.getReg_dt())%></td>					
											
												
												<td><b>조회수</b></td>
												<td><%=CmmUtil.nvl(eventDto.getRead_cnt())%></td>
											</tr>
											<tr>
												<td align="center" style="width: 100px"><b>사진</b></td>
												<td colspan="5"><input type="button" id="fileGRP"
											...
											<tr>
												...
												<td colspan="5"><textarea name="contents" maxlength="2000" style="width: 600px; height:300px;"
												 onkeyup="fc_chk_byte(this,4000);"><%=CmmUtil.nvl(eventDto.getContents())%></textarea>
												</td>
											</tr>
