...
<div class="wrapper">
    ...
    <div class="content" style="display:block;">
        <div class="content_wrapper">
        	<header><span>이벤트 수정</span></header>
			<div class="section">
                <!-- group -->
               <div class="input_row">
					<span class="input_box">
						<label class="lbl" >제목</label>
						<input type="text" placeholder="제목" name="title" class="input_area" 
						maxlength="50" value="<%=CmmUtil.nvl(eventDto.getTitle())%>">
					</span>
				</div>
				...
				<div class="input_content">
					<span class="input_box">
                        <textarea name="contents" maxlength="2000"><%=CmmUtil.nvl(eventDto.getContents())%></textarea>
					</span>
				</div>
            </div>
        </div>
    ...
    <div class="content wrapper50">
	    ...
	    <input type="button" title="취소" value="취소"  onclick="location.href='guestEventList.do'" class="btn_half left">
    </div>
