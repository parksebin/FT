...
<script type="text/javascript">
	...
	*/
	...
	//댓글 리스트 조회하기
	function doCommList(){
		xmlHttpPost("/event/guestCommentList.do", "ent_seq=<%=CmmUtil.nvl(eventDto.getEnt_seq())%>" , "viewResult");
	...
	function saveComment() {
		...
		if (commentSaveType=="A"){
			var actionUrl = "/event/guestInsertComment.do"; //호출 url 
		...
		//댓글 수정			
			...
			var actionUrl = "/event/guestUpdateComment.do"; //호출 url 
	...
	function doCommentDelete(com_seq){
		...
		if(confirm("삭제하시겠습니까?")){
			var actionUrl = "/event/guestDeleteComment.do"; //호출 url 
	...
	function moreViewComment(){
		...
		var actionUrl = "/event/guestCommentList.do"; //호출 url 
        ...
        <div class="content_wrapper">
			...
			<div class="section3">
              ...
              <div class="view_modify btn_wrap">                
				<input type="button" title="목록" value="목록" onclick="location.href='guestEventList.do'" class="btn_global">
			 <div class='clear'></div>
		    ...
		    <ul class="reply">
		  	   <li>
   				...
   				<%	if (session.getAttribute("USER_NO") == null || session.getAttribute("USER_NAME").equals("")) {%>
                	<textarea name="contents" placeholder="로그인 후 댓글 등록이 가능합니다"  readonly></textarea>
