...
<div class="wrapper">
			...
			<div class="section">
               ...
               <div class="input_row">
					<span class="input_box">
						...
						<input type="text" placeholder="제목" name="title" class="input_area" value="<%=CmmUtil.nvl(communityDto.getTitle())%>"
					maxlength="50">
					</span>
				</div>
    ...
    <div class="content wrapper50">
	    ...
	    <input type="button" title="취소" value="취소"  onclick="location.href='busicommunityList.do'" class="btn_half left">
    </div>
