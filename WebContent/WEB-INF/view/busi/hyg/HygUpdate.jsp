...
<div class="wrapper">
    ...
    <form name="f" id="f" method="post" action="/hyg/busihygUpdate.do">
			...
			<div class="section">
               ...
               <div class="input_row">
					<span class="input_box">
						...
						<input type="text" placeholder="제목" class="input_area" name="title" maxlength="50" value="<%=CmmUtil.nvl(hygDto.getTitle())%>" 
                  />
					</span>
				</div>
				...
				<div class="input_content input_box" style="height:600px">
                        ...
                        <textarea name="contents" placeholder="내용" maxlength="2000"style="height:600px" ><%=CmmUtil.nvl(hygDto.getContents())%></textarea>
