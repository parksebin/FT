...
<head>
    ...
    <script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?clientId=PVnCUExXvvcO11Ot9WMd"></script>
...
<div class="wrapper">
    ...
    <%if(auth.equals("P") || auth.equals("A")){ %>
    <input type="button" title="위치조회" value="위치조회" class="btn_global" onclick="location.href='/busi/position/gpsUpdateForm.do'">
    <%} %>
    <!-- join -->
    <!-- E: CONTENT -->
