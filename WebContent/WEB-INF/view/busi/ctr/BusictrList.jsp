...
<script type="text/javascript">
	function userReg() {
		location.href = "/ctr/BusictrRegform.do";
	}
	//전체 선택 해제
	...
	function userupdate_check() {
		...
		if (checked) {
			if (confirm("선택한것을 수정하시겠습니까?")) {
				f.action = "/ctr/BusiupdateCheck.do";
				f.submit(); //폼 submit;
			}
	...
	function doCommList() {
		...
		xmlHttpPost("/ctr/busiCtrIndex.do", searchParameter, "viewResult");
	...
	function viewResult(result) {
		...
		for (var i = 0; i < jsonObj.list.length; i++) {
			...
			tag += "<select class='status' name='pro_"+jsonObj.list[i].CTR_SEQ+"' id='auth_"+ jsonObj.list[i].CTR_SEQ +"'>";
	...
	function moreViewComment() {
		...
		var actionUrl = "/ctr/busiCtrIndex.do"; //호출 url 
		...
		<div class="content" style='display: block;'>
			<div class="content_wrapper">
							...
							<div id="search">
								...
								<div class="input_row w45">
									<span class="input_box"> <input type="text"
										id="searchText" name="searchText" placeholder="제목 / 아이디"
				...
				<form name="f" id="f" method="post"
					action="BusideleteAllCheckList.do">
					<div class='section'>
