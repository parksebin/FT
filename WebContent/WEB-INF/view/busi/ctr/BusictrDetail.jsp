		...
		<div class="content view" style="display: block;">
			<div class="content_wrapper">
				<header>
					...
					<span class='view_info'> <span><%=CmmUtil.nvl(ctrDto.getUser_name())%></span>  
					<br /> <%=CmmUtil.nvl(ctrDto.getReg_dt())%>
					</span>
				</header>
				...
				<div class="section">
					...
					<%-- 	<%if(auth.equals("A") || auth.equals("P")) {%> --%>
							...
							<input type="button" value="목록" onclick="location.href='/ctr/BusictrList.do'" class="btn_tri"/>
						<%-- <%} else if(auth.equals("U")){ %> --%>
						<!-- <input type="button" value="수정" onclick="doAction('U')" class="btn_half" />
							<input type="button" value="목록" onclick="location.href='/ctr/BusictrList.do'" class="btn_half" /> -->
						<%-- <%} %> --%>
					</form>
