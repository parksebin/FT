...
//*f는 form 태그 안의 id임*//
			...
			/*10.06 if (f.ctr_yn.value==""){alert("공지여부를 입력하시길 바랍니다.");f.ctr_yn.focus();return;} */
...
<div class="wrapper">
    ...
    <div class="content" style="display:block;">
        <div class="content_wrapper">
        	...
        	<form name="f" id="f" method="post" action="/ctr/BusictrReg.do" >
			...
			<div class="section">
	            ...
	            <div class="input_row">
					<span class="input_box">
						...
						<input type="text" name="people" maxlength="4"  onkeyup="this.value=SetComma(this.value)" class="input_area" placeholder="예상인원"/>			
					</span>
				</div>
...
<!-- 				<div class="group" style='display:block;height:40px;' > -->
	...
	<div class="content wrapper50">
		...
		<input type="button" value="목록" onclick="location.href='/ctr/BusictrList.do'" class="btn_half left"/>
    </div>
