	...
	<div class="wrapper">
		...
		<div class="content" style="display: block;">
			<div class="content_wrapper">
				...
				<form name="f" id="f" method="post" action="busiUserUpdate.do" onsubmit="return doAction2(this)">
				<input type="hidden" name="user_no" value="<%=CmmUtil.nvl(userDto.getUser_no())%>" />
					<div class="section">
						<!-- group -->
							<div class="input_row" style="background-color: #e2e2e2;">
								<span class="input_box" style="background-color: #e2e2e2;"> <label class="lbl">아이디</label> <input
									type="text" value="<%=CmmUtil.nvl(userDto.getUser_id())%>" id="user_id" name="user_id" 
									class="input_email" style=" background-color: #e2e2e2; " onkeydown="check(this,20)" readOnly />
								</span>
							</div>
						...
						<div class="input_row">
							<span class="input_box"> <label class="lbl">비밀번호</label> <input
								type="password" value="<%=CmmUtil.nvl(userDto.getPassword())%>" name="password" id="password" onkeydown="passwordcheck(this,20)" placeholder="비밀번호"
								class="input_area" maxlength="20">
							</span>
						</div>
						<div class="input_row">
						...
						<div class="input_row">
							<span class="input_box"> <label class="lbl">생년월일</label> <input
								type="text" value="<%=CmmUtil.nvl(userDto.getBirthday())%>" placeholder="생년월일 ex)1998년 2월 14일생이면 980214" class="input_area" value=""
						...
						<div class="input_row" style="background-color: #e2e2e2;">
							<span class="input_box" style="background-color: #e2e2e2;"> <label class="lbl">이름</label> <input
								...
								placeholder="이름" class="input_area" value="" onkeydown="namecheck(this,20)" readOnly>
							</span>
						</div>
						<div class="input_row">
							<span class="input_box"> <label class="lbl">마일리지
									확인</label> <input type="text" name="mileage"
								id="mileage" value="<%=CmmUtil.nvl(userDto.getMileage())%>" onkeyup="this.value=SetComma(this.value)" placeholder="마일리지"
								class="input_area" style="width: 250px" maxlength="10">
							</span>
						</div>
						<!-- group -->
						<div class="group">
							<div class="input_row phone">
								<span class="input_box"> <label class="lbl">이메일</label><input
									type="text" value="<%=CmmUtil.nvl(userDto.getEmail1())%>" name="email1" id="email1"  placeholder="이메일"
									class="input_phone" onkeydown="emailcheck(this,20)" maxlength="20">
								</span>
							</div>
							<label class='dash'> @ </label>
							<div class="input_row phone">
								<span class="input_box"> <label class="lbl"></label> <input
									type="text" value="<%=CmmUtil.nvl(userDto.getEmail2())%>" name="email2" id="email2"  placeholder=""
									class="input_phone" onkeydown="email2check(this,20)" maxlength="20">
								</span>
							</div>
							<label class='dash'> </label>
						...
						<div class="group">
							...
							<div class="input_row phone">
								<span class="input_box"> <label class="lbl">전화번호</label>
									...
									name="tel_2" id="tel_2" onkeydown="tel2()" maxlength="4">
								</span>
							</div>
							<label class='dash'> - </label>
							<div class="input_row phone">
								<span class="input_box"> <label class="lbl">전화번호</label>
									...
									name="tel_3" id="tel_3" onkeydown="tel3()" maxlength="4">
								</span>
							</div>
						</div>
					...
					<div class='content wrapper50'>
						...
						<input type="button" title="취소" value="취소" class="btn_half left"  onclick="location.href='/user/busiUserList.do'">
					</div>
					</div>
				</form>
			</div>
