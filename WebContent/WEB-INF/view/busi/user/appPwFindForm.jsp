...
<body>
	...
	<div class="wrapper">
		...
		<!-- S: CONTENT -->
		<!-- find_pwd -->
		<div class="content find_pwd" style="display: block;">
			<div class="content_wrapper">
				<header>
					<span>비밀번호 찾기</span>
				</header>
				<form name="f" id="f" method="post" action="appPwFindProc.do"
					onsubmit="return doAction(this)">
					<div class='section'>
						<div class="input_row">
							<span class="input_box"> <label class="lbl">이름</label> <input
								type="text" placeholder="이름" name="user_name" class="input_area"
						...
						<div class="input_row">
							<span class="input_box"> <label class="lbl">아이디</label> <input
								...
								value="" onkeydown="check(this,20)" maxlength="20">
							</span>
						</div>
						<!-- group -->
						<div class="group">
							<div class="input_row phone">
								<span class="input_box"> <label class="lbl">이메일</label><input
									type="text" name="email1" maxlength="20" placeholder="이메일"
									class="input_phone" value="" onkeydown="emailcheck(this,20)" >
								</span>
							</div>
							...
							<div class="input_select phone">
								<select name="email3"
									onchange="doChangeEmail(this.form, this.value)">
