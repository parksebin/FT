...
<script type="text/javascript">
	...
	function doKeyOnlyNumber(event) {
		...
		if ((keyID >= 48 && keyID <= 57) || (keyID >= 96 && keyID <= 105)
				|| keyID == 9 || keyID == 8 || keyID == 46 || keyID == 37 || keyID == 39)//백스페이스, 딜리트 ,<-방향키,방향키->
				{
			return;
		} else {
			return false;
					...
					<div class="section">
						...
						<div class="group">
							<div class="input_row id_check">
								<span class="input_box"> <label class="lbl">아이디</label> <input
									...
									class="input_email" style="width: 250px" onkeydown="check(this,20)" maxlength="20" />
								</span>
							</div>
						...
						<div class="input_row">
							<span class="input_box"> <label class="lbl">이름</label> <input
								...
								placeholder="이름" class="input_area" value="" onkeydown="namecheck()" maxlength="20">
							</span>
						</div>
						<div class="input_row">
							<span class="input_box"> <label class="lbl">생년월일</label> <input
								type="text" placeholder="생년월일" class="input_area" value=""
								 name="birthday" onkeydown="birth()" maxlength="6">
							</span>
						</div>
						<!-- group -->
						<div class="group">
							<div class="input_row phone">
								<span class="input_box"> <label class="lbl">이메일</label><input
									type="text" name="email1" placeholder="이메일"
							...
							<div class="input_row phone">
								<span class="input_box"> <label class="lbl"></label> <input
									...
									class="input_phone" value="email2check(this, 20)" maxlength="20">
								</span>
							</div>
							<label class='dash'> </label>
						...
						<div class="group">
							...
							<div class="input_row phone">
								<span class="input_box"> <label class="lbl">전화번호</label>
									<input type="text" placeholder="전화번호" class="input_phone"
									value="" name="tel_2" id="tel_2"
									onkeydown="tel2()" maxlength="4">
								</span>
							</div>
							<label class='dash'> - </label>
							<div class="input_row phone">
								<span class="input_box"> <label class="lbl">전화번호</label>
									...
									value="" name="tel_3" id="tel_3" 
									onkeydown="tel3()" maxlength="4">
								</span>
							</div>
						</div>
						<!-- group -->
