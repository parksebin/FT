...
<div class="wrapper">
    ...
    <form name="f" id="f" method="post" action="busiupdate.do">
        ...
        <div class="content_wrapper">
			...
			<div class="section">
               ...
               <div class="input_row">
				 ...
				 value="<%=CmmUtil.nvl(eventDto.getTitle())%>">
					</span>
				</div>
    ...
    <div class="content wrapper50">
	    ...
	    <input type="button" title="취소" value="취소"  onclick="location.href='busieventList.do'" class="btn_half left">
    </div>
