    ...
    <div class="content" style='display:block;'>
        <div class="content_wrapper">
			...
			<div class='section'>
				...
				%>
                    <li>
                        <a href="/busi/schedule/scheduleDetail.do?sch_seq=<%=CmmUtil.nvl(scheduleDTO.getSch_seq()) %>">
                ...
                <!-- list -->
                <input type="button" title="확인" value="확인" class="btn_global" onclick="location.href = '/busi/schedule/calendar.do'">
        	</div>
		</div>
    </div>
	<!-- login -->
