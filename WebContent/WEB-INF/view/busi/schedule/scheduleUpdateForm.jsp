...
<div class="wrapper">
    ...
    <!-- S: CONTENT -->
     <!-- join -->
     <form action="/busi/schedule/scheduleUpdateProc.do" name="f" onsubmit="return check(this)" method="post">
			...
			<div class="section">
               ...
               <div class="input_row">
					<span class="input_box">
						...
						<input type="text" placeholder="제목" class="input_area" value="<%=CmmUtil.nvl(scheduleDto.getTitle()) %>" name="title">
					</span>
				</div>
				...
				<div class="group">
					<a class="input_row date">
						<span class="input_box">
							...
							<input type="text" placeholder="시작일" class="input_area datepicker" value="<%=CmmUtil.nvl(scheduleDto.getPl_dt1()) %>" name="pl_dt1">
						</span>	
					</a>
					...
					<a class="input_row date">
						<span class="input_box">
							...
							<input type="text" placeholder="종료일" class="input_area datepicker" value="<%=CmmUtil.nvl(scheduleDto.getPl_dt2()) %>" name="pl_dt2">
						</span>	
					</a>
				</div>
                <!-- group -->
    ...
    <div class="content wrapper50">
	    ...
	    <input type="button" title="취소" value="취소" class="btn_half left" onclick="location.href='/busi/schedule/scheduleDetail.do?sch_seq=<%=CmmUtil.nvl(scheduleDto.getSch_seq()) %>'">
    </div>
    </form>
    <!-- E: CONTENT -->
